...
if (isset($_POST["registrar"])){
	//con esto no permitimos que el usuario no pueda ingresar algunas sentencias sql para evitar inyección.
	...
	//no permitir que ingrese duplicar el usuario
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; PROYECTO PPS</h4>
							</div>
